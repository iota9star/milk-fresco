...
import f.star.iota.milk.ui.miaowu.wu.WuFragment;


public class MiaoWuViewHolder extends BaseViewHolder<MiaoWuBean> {
    ...
    public MiaoWuViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final MiaoWuBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(WuFragment.newInstance(bean.getUrl()));
            }
        });
