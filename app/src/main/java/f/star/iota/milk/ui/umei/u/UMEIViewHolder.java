...
import f.star.iota.milk.ui.umei.mei.MEIFragment;


public class UMEIViewHolder extends BaseViewHolder<UMEIBean> {
    ...
    public UMEIViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final UMEIBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(MEIFragment.newInstance(bean.getUrl()));
            }
        });
