...
import f.star.iota.milk.ui.moeimg.img.ImgFragment;


public class MoeimgViewHolder extends BaseViewHolder<MoeimgBean> {
    ...
    public MoeimgViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final MoeimgBean bean) {
        if (bean.getUrl() != null) {
        ...
        mSimpleDraweeView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(ImgFragment.newInstance(bean.getUrl()));
            }
        });
