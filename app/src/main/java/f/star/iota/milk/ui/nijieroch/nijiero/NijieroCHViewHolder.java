...
import f.star.iota.milk.ui.nijieroch.ch.CHFragment;


public class NijieroCHViewHolder extends BaseViewHolder<NijieroCHBean> {
    ...
    public NijieroCHViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final NijieroCHBean bean) {
        if (bean.getUrl() != null) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(CHFragment.newInstance(bean.getUrl()));
            }
        });
