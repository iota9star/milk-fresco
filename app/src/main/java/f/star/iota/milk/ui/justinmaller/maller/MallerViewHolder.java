...
public class MallerViewHolder extends BaseViewHolder<MallerBean> {
    @BindView(R.id.card_view)
    CardView mCardView;
    @BindView(R.id.simple_drawee_view_image)
    SimpleDraweeView mSimpleDraweeView;

    public MallerViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final List<MallerBean> beans) {
        final MallerBean bean = beans.get(getAdapterPosition());
