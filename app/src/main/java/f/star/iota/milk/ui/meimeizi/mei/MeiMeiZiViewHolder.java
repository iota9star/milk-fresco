...
import f.star.iota.milk.ui.meimeizi.meizi.MeiZiFragment;


public class MeiMeiZiViewHolder extends BaseViewHolder<MeiMeiZiBean> {
    ...
    public MeiMeiZiViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final MeiMeiZiBean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(MeiZiFragment.newInstance(bean.getUrl() + "/"));
            }
        });
