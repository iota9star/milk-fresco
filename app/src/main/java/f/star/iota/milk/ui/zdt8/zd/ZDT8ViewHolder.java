...
import f.star.iota.milk.ui.zdt8.t8.T8Fragment;


public class ZDT8ViewHolder extends BaseViewHolder<ZDT8Bean> {
    ...
    public ZDT8ViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final ZDT8Bean bean) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(T8Fragment.newInstance(bean.getUrl()));
            }
        });
