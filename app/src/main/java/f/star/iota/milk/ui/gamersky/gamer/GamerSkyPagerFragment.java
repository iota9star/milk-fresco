...
public class GamerSkyPagerFragment extends PagerFragment {
    ...
    protected TitlePagerAdapter getPagerAdapter() {
        ...
        fragments.add(GamerSkyFragment.newInstance(Net.ACG_GAMERSKY_ZX));
        fragments.add(GamerSkyFragment.newInstance(Net.ACG_GAMERSKY_PC));
        fragments.add(GamerSkyFragment.newInstance(Net.ACG_GAMERSKY_SJ));
        fragments.add(GamerSkyFragment.newInstance(Net.ACG_GAMERSKY_MT));
