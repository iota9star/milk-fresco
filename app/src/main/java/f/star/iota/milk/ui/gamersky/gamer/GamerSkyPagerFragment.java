...
public class GamerSkyPagerFragment extends PagerFragment {
    ...
    protected TitlePagerAdapter getPagerAdapter() {
        ...
        fragments.add(GamerSkyFragment.newInstance(Net.GAMERSKY_ZX));
        fragments.add(GamerSkyFragment.newInstance(Net.GAMERSKY_PC));
        fragments.add(GamerSkyFragment.newInstance(Net.GAMERSKY_SJ));
        fragments.add(GamerSkyFragment.newInstance(Net.GAMERSKY_MT));
