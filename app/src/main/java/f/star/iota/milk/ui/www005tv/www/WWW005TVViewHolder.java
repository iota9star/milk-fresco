...
import f.star.iota.milk.ui.www005tv.tv.TVFragment;


public class WWW005TVViewHolder extends BaseViewHolder<WWW005TVBean> {
    ...
    public WWW005TVViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final WWW005TVBean bean) {
        if (bean.getUrl() != null) {
