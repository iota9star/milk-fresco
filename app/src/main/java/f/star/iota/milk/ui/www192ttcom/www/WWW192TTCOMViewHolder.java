...
import f.star.iota.milk.ui.www192ttcom.tt.TTFragment;


public class WWW192TTCOMViewHolder extends BaseViewHolder<WWW192TTCOMBean> {
    ...
    public WWW192TTCOMViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final WWW192TTCOMBean bean) {
        if (bean.getUrl() != null) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(TTFragment.newInstance(bean.getUrl().replace(".html", "_")));
            }
        });
