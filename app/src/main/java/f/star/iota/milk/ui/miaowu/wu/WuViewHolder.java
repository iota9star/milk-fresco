...
public class WuViewHolder extends BaseViewHolder<WuBean> {
    ...
    @Override
    public void bindView(final List<WuBean> beans) {
        final WuBean bean = beans.get(getAdapterPosition());
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (WuBean bean : beans) {
                    imgs.add(new PCBean(bean.getUrl(), bean.getUrl(), Menus.MENU_MIAOWU,
                            "下载地址：" + bean.getUrl()));
                }
                show(imgs);
            }
