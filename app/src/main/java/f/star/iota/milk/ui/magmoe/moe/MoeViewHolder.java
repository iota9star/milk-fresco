...
public class MoeViewHolder extends BaseViewHolder<MoeBean> {

    @BindView(R.id.simple_drawee_view_image)
    SimpleDraweeView mSimpleDraweeView;

    public MoeViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final List<MoeBean> beans) {
        final MoeBean bean = beans.get(getAdapterPosition());
        if (bean.getUrl() != null) {
                        ...
                        .setPositiveButton("下载", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                download(bean.getUrl(), bean.getUrl(),
                                        Contracts.Menu.MENU_MAG_MOE, null);
                            }
                        })
                        .show();
                return true;
        ...
        mSimpleDraweeView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (MoeBean bean : beans) {
                    imgs.add(new ShowImageBean(bean.getUrl(), bean.getUrl(), Contracts.Menu.MENU_MAG_MOE,
                            "下载地址：" + bean.getUrl()));
                }
                show(imgs);
            }
