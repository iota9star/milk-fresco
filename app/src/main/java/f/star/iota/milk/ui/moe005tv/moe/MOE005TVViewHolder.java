...
import f.star.iota.milk.ui.moe005tv.tv.TVFragment;


public class MOE005TVViewHolder extends BaseViewHolder<MOE005TVBean> {
    ...
    public MOE005TVViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void bindView(final MOE005TVBean bean) {
        if (bean.getUrl() != null) {
        ...
        mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((BaseActivity) mContext).addFragment(TVFragment.newInstance(bean.getUrl()));
            }
        });
